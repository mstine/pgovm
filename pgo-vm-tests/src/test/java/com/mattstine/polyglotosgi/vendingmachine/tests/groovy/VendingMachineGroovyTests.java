package com.mattstine.polyglotosgi.vendingmachine.tests.groovy;
...
public class VendingMachineGroovyTests {
    ...
    @Configuration
       public static Option[] configuration()
       {
          return options(equinox(), provision(              
              ...
              mavenBundle().groupId("com.mattstine.polyglotosgi.vendingmachine").artifactId("pgo-vm-groovy-impl"),
              mavenBundle().groupId("org.codehaus.groovy").artifactId("groovy-all").version("1.6.0")
          ));
       }
}